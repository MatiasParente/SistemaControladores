...
export default function FilterUser({ empresas, filtroActual, filtroActualEmpresa }){
    ...
    return (
        <div className="bg-[#0B1121] p-4 md:p-5 rounded-3xl border border-gray-800 shadow-xl mb-6">
            <div className="flex flex-col md:flex-row items-center gap-4">
                <form onSubmit={handleSearch} className="relative w-full md:flex-1">
                    ...
                    <input
                        ...
                        className="block w-full pl-11 pr-4 py-3 bg-[#070b14] border border-gray-800 rounded-2xl text-slate-200 placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all shadow-inner"
                        value={searchTerm}
                ...
                <div className="relative w-full md:w-80">
                    ...
                    <select
                        ...
                        className="block w-full pl-11 pr-10 py-3 bg-[#070b14] border border-gray-800 rounded-2xl text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all appearance-none cursor-pointer shadow-inner"
                    >
